    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto mt-20">
        ...
        <div className="bg-gray-800/50 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-700/30 overflow-hidden">
          ...
          <div className="bg-gray-800 px-4 py-3 border-b border-gray-700/30 flex items-center">
          ...
          <div className="flex">
            <LineNumbers />
            <textarea
              className="w-full min-h-[24rem] px-4 py-3 bg-gray-900/50 text-gray-100 border-l border-gray-700/50 focus:outline-none font-mono text-sm leading-6 resize-none"
          ...
          <div className="bg-gray-800/50 p-4 border-t border-gray-700/30">
            <div className="flex items-center space-x-4">
              <label htmlFor="fileUpload" className="flex items-center justify-center px-6 py-2 bg-gray-700/20 text-gray-100 border border-gray-700/50 rounded-lg cursor-pointer hover:bg-gray-700/30 transition-colors duration-200">
        ...
        <div className="flex justify-end mt-6">
          <button
            ...
            className={`px-8 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl font-medium 
