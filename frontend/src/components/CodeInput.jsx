            ...
            <div className="mt-8 space-y-6">
                ...
                {Object.entries(review.metrics).map(([key, value]) => (
                  <div key={key} className={`${
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="text-xs uppercase tracking-wider text-gray-400">{key}</h3>
                      <BarChart4 className="h-4 w-4 text-red-500" />
                    </div>
              ...
              <div className={`${
                ...
                <div className="p-4 sm:p-6">
                  {!review.corrections?.hasCorrections ? (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`ml-auto px-2 py-0.5 rounded-full text-sm ${
                        review.structureAnalysis.score >= 80 ? 'bg-green-500/20 text-green-400' :
                        review.structureAnalysis.score >= 60 ? 'bg-yellow-500/20 text-yellow-400' :
                        ...
                        <div key={index} className={`${
                          ...
                          <div className="flex items-start gap-3">
                            <div className={`p-2 rounded-lg ${
                              finding.severity === 'error' ? 'bg-red-500/10' : 
                              finding.severity === 'warning' ? 'bg-yellow-500/10' : 
                              'bg-blue-500/10'
                            }`}>
                              {finding.severity === 'error' ? <AlertTriangle className="h-5 w-5 text-red-400" /> :
                               finding.severity === 'warning' ? <Info className="h-5 w-5 text-yellow-400" /> :
                ...
                <div className={`${
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`ml-auto px-2 py-0.5 rounded-full text-sm ${
                        review.implementationReview.score >= 80 ? 'bg-green-500/20 text-green-400' :
                        review.implementationReview.score >= 60 ? 'bg-yellow-500/20 text-yellow-400' :
                        'bg-red-500/20 text-red-400'
                      } font-medium`}>
                ...
                <div className={`${
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className={`ml-auto px-2 py-0.5 rounded-full text-sm ${
                        review.bestPractices.score >= 80 ? 'bg-green-500/20 text-green-400' :
                        review.bestPractices.score >= 60 ? 'bg-yellow-500/20 text-yellow-400' :
                        'bg-red-500/20 text-red-400'
                      } font-medium`}>
